...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl font-semibold transition-all duration-200 ease-smooth disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-r from-primary via-violet-600 to-indigo-600 text-white shadow-[0_0_20px_rgba(108,29,255,0.4)] hover:shadow-[0_0_28px_rgba(108,29,255,0.65)] hover:brightness-110 active:scale-[0.98]",
        secondary:
